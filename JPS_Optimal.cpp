// My implementation of Jump Point Search(JPS) path finding algorithm
// Author : Ahmad Reza Parsi Zadeh
// Gmail  : ahmadreza.parsizadeh@gmail.com
#include <cfloat>
#include <set>
#include <stack>
#include <cmath>
...
public:
    //Set the start and end position manually
    void getStartPos() { sta = M_P(100, 150);}
    void getEndPos() { end = M_P(348, 501); }
